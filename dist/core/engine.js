...
exports.AdvancedCodingEngine = void 0;
const logger_1 = require("./logger");
const config_1 = require("./config");
const ai_1 = require("../ai");
const simple_analyzer_1 = require("../analysis/simple-analyzer");
class AdvancedCodingEngine {
    logger;
    configManager;
    aiProvider;
    codeAnalyzer;
    ...
    constructor() {
        ...
        this.aiProvider = new ai_1.AIProvider();
        this.codeAnalyzer = new simple_analyzer_1.SimpleCodeAnalyzer();
    ...
    async getCompletions(context) {
        ...
        // 分析当前代码上下文
        const analysis = await this.codeAnalyzer.analyzeCode(context.content, context.language, context.filePath);
    ...
    buildCodeGenerationPrompt(context, prompt) {
        return `
...
`;
    ...
    buildCompletionPrompt(context, analysis) {
        return `
Current file: ${context.filePath}
Language: ${context.language}
...
`;
    ...
    getContextAroundCursor(context) {
...
exports.AdvancedCodingEngine = AdvancedCodingEngine;
